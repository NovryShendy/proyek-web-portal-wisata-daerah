    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="<?= base_url('wisata/create_process') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hari" placeholder="Harga" name="hari" reqired>
                    </div>
