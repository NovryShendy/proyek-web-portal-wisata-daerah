...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url('template/rhea/public/assets/img/favicons/apple-touch-icon.png') ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url('template/rhea/public/assets/img/favicons/favicon-32x32.png') ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('template/rhea/public/assets/img/favicons/favicon-16x16.png') ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('template/rhea/public/assets/img/favicons/favicon.ico') ?>">
    <link rel="manifest" href="<?= base_url('template/rhea/public/assets/img/favicons/manifest.json') ?>">
    <meta name="msapplication-TileImage" content="<?= base_url('template/rhea/public/assets/img/favicons/mstile-150x150.png') ?>">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="<?= base_url('template/rhea/public/vendors/plyr/plyr.css') ?>" rel="stylesheet">
    <link href="<?= base_url('template/rhea/public/assets/css/theme.css') ?>" rel="stylesheet" />
...
<body>
    ...
    <main class="main" id="top">
        <!-- Navbar -->
        <?php $this->load->view('include_home/navbar') ?>

        <!-- Jumbotron -->
        <?php $this->load->view('include_home/jumbotron') ?>



        <!-- ============================================-->
        <!-- <section> begin ============================-->
        <?php $this->load->view('include_home/list_wisata') ?>
        <!-- <section> close ============================-->
        <!-- ============================================-->
        ...
        <!-- ============================================-->
        <!-- <section> begin ============================-->
        <?php $this->load->view('include_home/vidio') ?>
        <!-- <section> close ============================-->
        <!-- ============================================-->
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="<?= base_url('template/rhea/public/vendors/@popperjs/popper.min.js') ?>"></script>
    <script src="<?= base_url('template/rhea/public/vendors/bootstrap/bootstrap.min.js') ?>"></script>
    <script src="<?= base_url('template/rhea/public/vendors/is/is.min.js') ?>"></script>
    <script src="<?= base_url('template/rhea/public/vendors/plyr/plyr.polyfilled.min.js') ?>"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="<?= base_url('template/rhea/public/assets/js/theme.js') ?>"></script>
